...
import conerthallYaml from '../concerthall.yaml';
import ConcertHall from "../interfaces/ConcertHall";

const concertHalls: ConcertHall[] = conerthallYaml as ConcertHall[];

export const ConcertHallPage: React.FC = () => {
